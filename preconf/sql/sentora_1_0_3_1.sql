...
/* REMOVED Update the sentora database version number REMOVED*/
/*UPDATE `x_settings` SET `so_value_tx` = '1.0.3.1-Build 0.3.2-BETA' WHERE `so_name_vc` = 'dbversion';*/
...
/* Enter new tables to x_settings sentora database for apache_admin */
